...
const services = [
  ...
  },
  {
    ...
    title: "Bowl Blending",
    desc: "Precision blending under the valve seats for smooth, unseparated flow. Critical for high-RPM performance.",
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-10 h-10" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "Valve Jobs",
    desc: "Multi-angle valve seat cutting for perfect sealing and maximum flow coefficient. Includes stem seal replacement.",
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" className="w-10 h-10" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Hand-worked to a mirror finish inside ports and combustion chambers. Reduces carbon buildup and boosts efficiency.",
  },
];
